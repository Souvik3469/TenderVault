...
const UpdateTender = () => {
  ...
  const [tenderName, setTenderName] = useState('Tender 1');
  const [description, setDescription] = useState('Description for Tender 1');
  ...
  const handleSubmit = (e) => {
    ...
    // Perform actions with updated form data (e.g., send to a server)
  ...
  return (
    <div className="bg-gray-200 min-h-screen flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-lg">
        <h1 className="text-2xl font-semibold text-center text-gray-900 mb-4">Update Tender</h1>
